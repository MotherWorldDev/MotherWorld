...
Habitat, vegetation, pollution, and freshwater historical backbones are still being acquired or validated. The C3S 1993 land-cover pilot has been downloaded and verified through CDS; the complete history is still pending. NOAA NDVI can be accessed directly; the historical transfer strategy is still being assessed. The direct MERRA-2 route requires NASA Earthdata access. The combined Earth Health score remains unavailable until all nine families satisfy the fixed composition and coverage contract. Regional geology and other diagnostic builds are integrated only after their canonical region IDs and source coverage are checked.
